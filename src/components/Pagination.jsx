    ...
    <div className="flex flex-col items-center py-14 max-w-[700px] ">
      <div className="relative text-[#4285f4]">
        {queries.previousPage && (
          <div className="absolute left-[-30] md:left-[-40px] top-[10px] onClick={()=>paginationClickHandler(queries.previousPage[0].startIndex)}">
        ...
        {queries.nextPage && (
          <div
            className="absolute right-[-30] md:right-[-40px] top-[10px]"
            onClick={() =>
